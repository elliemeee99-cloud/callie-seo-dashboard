...
CACHE_FILE = "seo_monthly_sales_v6.pkl"
...
with st.container(border=True):
    ...
    if uploaded_file is not None:
        try:
            ...
            # 🔥 全新强锚点双轨识别：分别认准“非品牌”与“ALL”所在的带“总计”的行
            nb_idx = -1
            all_idx = -1
            ...
            for i, row in df_raw.iterrows():
                ...
                if '总计' in row_joined:
                    if '非品牌' in row_joined:
                        nb_idx = i
                    elif 'ALL' in row_joined:
                        all_idx = i
            ...
            if nb_idx != -1 and all_idx != -1:
                ...
                st.success("✅ 数据报表完美解析！已自动分离【非品牌词】与【ALL SEO】指标大盘。")
            else:
